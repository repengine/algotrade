...
from algostack.core.engine.execution_handler import ExecutionHandler
from algostack.core.engine.order_manager import OrderManager
from algostack.core.engine.trading_engine import TradingEngine
...
class TestOrderManager:
    ...
    def test_get_pending_orders(self, order_manager):
        ...
        order_manager.create_order('GOOGL', 10, 'BUY', 'LIMIT', 2800)
        order_manager.create_order('MSFT', 50, 'SELL', 'MARKET')
