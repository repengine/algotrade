...
from algostack.core.engine.order_manager import (
    Order,
    OrderFill,
    OrderManager,
    OrderSide,
...
class TestOrderManagerSync:
    ...
    def test_get_orders_by_strategy(self, order_manager):
        ...
        order1 = run_async(order_manager.create_order(
            "AAPL", OrderType.MARKET, OrderSide.BUY, 100, strategy_id="strategy_A"
        ))
        order2 = run_async(order_manager.create_order(
        ...
        order4 = run_async(order_manager.create_order(
