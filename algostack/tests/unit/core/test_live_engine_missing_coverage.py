...
from algostack.core.executor import OrderStatus, OrderType, Order, OrderSide, TimeInForce
from algostack.core.portfolio import Position
...
class TestLiveTradingEngineMissingCoverage:
    ...
    def test_initialize_executors(self):
        ...
        with patch('algostack.core.live_engine.PaperExecutor') as mock_paper_executor:
        ...
        with patch('algostack.core.live_engine.IBKRExecutor') as mock_ibkr_executor:
            ...
            with patch.object(LiveTradingEngine, '__init__', lambda self, config: None):
                ...
                engine.order_manager.register_executor = Mock()
                engine.order_manager.set_active_executor = Mock()
                engine._initialize_executors()
    ...
    def test_setup_schedule(self):
        ...
        assert any('_check_memory_health' in func for func in job_funcs)
        assert any('_check_stops' in func for func in job_funcs)
    ...
    async def test_check_memory_health(self):
        ...
        mock_memory_manager.optimize_memory = AsyncMock()
    ...
    async def test_check_stops(self):
        ...
        stop_order1.order_type = OrderType.STOP_LOSS
        ...
        stop_order2.order_type = OrderType.STOP_LOSS
