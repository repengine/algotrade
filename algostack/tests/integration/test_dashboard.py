...
class TestDashboardCallbacks:
    ...
    def test_interval_callback(self):
        ...
        assert any('interval-component' in str(cb) for cb in app.callback_map)
    ...
    def test_strategy_control_callback(self):
        ...
        # Test enable
        result = handle_strategy_toggle(1, 'test_strategy', mock_engine)
        mock_engine.enable_strategy.assert_called_with('test_strategy')
        
        # Test disable
        result = handle_strategy_toggle(0, 'test_strategy', mock_engine)
