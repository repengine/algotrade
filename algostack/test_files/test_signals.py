...
def test_rsi_signals():
    ...
    signals.loc[buy_condition == True, 'signal'] = 1
    signals.loc[sell_condition == True, 'signal'] = -1
...
def test_ma_crossover_signals():
    ...
    print("\nCrossover points:")
    crossovers = signals[signals['signal'] != 0][['price', 'fast_ma', 'slow_ma', 'signal']].head(10)
...
def test_trade_tracking():
    ...
    print(signals[signals['signal'] != 0][['signal', 'position', 'trade_entry', 'trade_exit']])
