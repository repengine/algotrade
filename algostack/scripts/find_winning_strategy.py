...
class MonthlyPerformanceOptimizer:
    ...
    def __init__(self, symbol: str = "SPY", start_date: str = "2021-01-01", end_date: str = "2023-01-01"):
        self.symbol = symbol
    ...
    def check_monthly_profitability(self, strategy_returns: pd.Series, benchmark_returns: pd.Series) -> Dict[str, Any]:
    ...
    def test_parameters(self, strategy_class, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            monthly_check = self.check_monthly_profitability(strategy_monthly, benchmark_monthly)
    ...
    def optimize_strategy(self, strategy_name: str, max_workers: int = 4) -> List[Dict[str, Any]]:
        ...
        with ProcessPoolExecutor(max_workers=max_workers) as executor:
            ...
            for future in as_completed(futures):
                ...
                if result:
                    ...
                    if result['all_profitable'] and result['all_beat_benchmark'] and result['num_months'] >= 24:
                        logger.info(f"FOUND WINNER! {strategy_name} with params: {result['params']}")
    ...
    def find_winning_strategy(self) -> Dict[str, Any]:
        ...
        for strategy_name in strategies:
            ...
            # Filter for winners
            winners = [r for r in results if r['all_profitable'] and r['all_beat_benchmark'] and r['num_months'] >= 24]
            if winners:
        ...
        all_results.sort(key=lambda x: (x['outperforming_months'], x['profitable_months'], x['avg_outperformance']), reverse=True)
...
def main():
    ...
    print(f"Outperforming Months: {winner['outperforming_months']}/{winner['num_months']}")
