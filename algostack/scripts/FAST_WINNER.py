...
def main():
    ...
    print(f"   Avg Monthly Return: {WINNING_CONFIG['performance']['avg_monthly_return']:.1f}%")
    print(f"   Avg Monthly Outperformance: {WINNING_CONFIG['performance']['avg_monthly_outperformance']:.1f}%")
