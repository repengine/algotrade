...
class VisualizedBacktester:
    ...
    def _calculate_metrics(self, portfolio_df, price_data):
        ...
        benchmark_return = (price_data['close'].iloc[-1] / price_data['close'].iloc[0] - 1) * 100
    ...
    def _create_visualizations(self, portfolio_df, trades_df, signals_df, price_data, symbol, metrics):
        ...
        # Add benchmark
        benchmark_value = self.initial_capital * (price_data['close'] / price_data['close'].iloc[0])
        ax1.plot(price_data.index, benchmark_value, 
        ...
        ax2.plot(price_data.index, benchmark_returns, 
