...
class IBKRAdapter:
    ...
    async def reauthenticate(self) -> bool:
        ...
        if result:
            self.logger.info("Reauthentication triggered. Please complete login in browser.")
            return True
        return False
    ...
    async def search_contracts(self, symbol: str, sec_type: Optional[str] = None) -> List[Contract]:
        ...
        result = await self._request("GET", "/v1/api/iserver/secdef/search", params=params)
    ...
    async def get_market_data_snapshot(
        ...
        result = await self._request("GET", "/v1/api/iserver/marketdata/snapshot", params=params)
    ...
    async def cancel_order(self, account: str, order_id: str) -> bool:
        ...
        result = await self._request(
            "DELETE",
            f"/v1/api/iserver/account/{account}/order/{order_id}"
        )
    ...
    async def get_account_info(self, account: Optional[str] = None) -> Optional[AccountInfo]:
    ...
    async def get_historical_data(
        ...
        result = await self._request("GET", "/v1/api/iserver/marketdata/history", params=params)
