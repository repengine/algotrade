...
class TestMetricsFinalCoverage:
    ...
    def test_import_fallback(self):
        ...
        with patch('core.metrics.BacktestMetrics', side_effect=ImportError):
            ...
            with patch.dict('sys.modules'):
                ...
                if 'core.backtest_metrics' in importlib.sys.modules:
                    del importlib.sys.modules['core.backtest_metrics']
