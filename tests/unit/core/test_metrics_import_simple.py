...
import core
if hasattr(core, 'backtest_metrics'):
    delattr(core, 'backtest_metrics')
...
exec(open('algostack/core/metrics.py').read(), {'__name__': 'core.metrics', '__file__': 'algostack/core/metrics.py'})
